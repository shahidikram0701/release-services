...
#
# COMMAND:
#   pypi2nix -v -C /tmp/release-services-yjt2x9fd/src/uplift/bot/../../../tmp/pypi2nix -V 3.7 -O ../../../nix/requirements_override.nix -E postgresql -E libffi -E openssl -E pkgconfig -E freetype.dev -s intreehooks -s flit -s pytest-runner -s setuptools-scm -r requirements.txt -r requirements-dev.txt
#
...
let
  ...
  generated = self: {
    ...
    "libmozdata" = python.mkDerivation {
      name = "libmozdata-0.1.51";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/0d/5e/2125e8095dea3c43bb73b1571a92f31e1af260c33fd42ecf838db5c51e08/libmozdata-0.1.51.tar.gz";
        sha256 = "f137624928b5ab220e89c29f834b9372fdd8532522bb20f28e3ec543a8ddc65e";
      };
      doCheck = commonDoCheck;
      checkPhase = "";
      installCheckPhase = "";
